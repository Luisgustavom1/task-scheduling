...
class RunStats:
    ...
    task_starts: Dict[int, Tuple[int, int, float]] = {}  # task -> (cores, memory, start_time)
    used_resources: set[int] = set()  # Set of resources used 
    task_resource: Dict[int, int] = {}
    resource_first_used: Dict[int, float] = {}  # resource -> first used time
    resource_last_used: Dict[int, float] = {}  # resource -> last used time
